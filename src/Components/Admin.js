    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'center', justifyContent: 'space-around' }}>
                <div style={{ border: '1px solid green', backgroundColor: 'green', color: 'white', borderRadius: '4px', width: '20%', marginTop: '20px' }}>
                ...
                <div style={{ border: '1px solid green', borderRadius: '4px', backgroundColor: 'blue', color: 'white', width: '20%', marginTop: '10px' }}>
                    <h1 style={{ textAlign: 'center' }}>Products</h1>
                    <hr />
                    <h1 style={{ textAlign: 'center' }}>Total Products</h1>
                    <h1 style={{ textAlign: 'center' }}>{productdata.length}</h1>
                </div>
                <div style={{ border: '1px solid green', borderRadius: '4px', backgroundColor: 'Pink', color: 'white', width: '20%', marginTop: '10px' }}>
                    <h1 style={{ textAlign: 'center' }}>Bills</h1>
                    <hr />
                    <h1 style={{ textAlign: 'center' }}>Total Bills</h1>
                    <h1 style={{ textAlign: 'center' }}>{billsdata.length}</h1>
                </div>
                <div style={{ border: "1px solid green", borderRadius: '4px', textAlign: 'center', backgroundColor: 'red', color: 'white', width: '25%', marginTop: '10px' }}>
                    <h1>Admin</h1>
                    <hr />
