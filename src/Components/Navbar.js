    ...
    return (
        <div>
            {loggedin ? (
                <>
                    <div>
                        <IdleTimer ref={idleTimerref} timeout={5 * 1000} onIdle={handleChange}>
                            <div style={{ backgroundColor: "#f1f1f1", padding: "30px" }}>
                                <Link className='text' to='/admin'>
                                    Dashboard
                                </Link>
                                <Link className='text' to='/customers'>
                                    Customers
                                </Link>
                                <Link className='text' to='/products'>
                                    Products
                                </Link>
                                <Link className='text' to='/bills'>
                                    Bills
                                </Link>
                                <Link
                                    className='text'
                            ...
                            <div>
                                <li>
                                    <Link className='txt' to='/'>
                                        <MdHome
                                            style={{ textAlign: "center", position: "relative", marginTop: "10px" }}
                                        />
                                        Home
                                    </Link>
                                </li>
                                <li>
                                    <Link className='txt' to='/register'>
                                        <FaRegIdCard style={{ textAlign: "center", position: "relative" }} />
                                        Register
                                    </Link>
                                </li>
                                <li>
                                    <Link className='txt' to='/login'>
                                        <AiOutlineLogin style={{ textAlign: "center", position: "relative" }} />
                                        Login
                                    </Link>
                                </li>
                            </div>
