    ...
    <div style={{ display: "flex", justifyContent: "space-around" }}>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          />
          {formerrors && (
            <span style={{ color: "red" }}>{formerrors.selectcustomer}</span>
          )}
          <br />
          <label>Product</label>
          <Select
          ...
          <br />
          {formerrors && (
            <span style={{ color: "red" }}>{formerrors.selectoption}</span>
          )}
          <br />
                ...
                return (
                  <tr key={i}>
                    ...
                    <td>
                      <button
                        onClick={() => {
                          handleChangeDecrement(ele.product, ele.quantity);
                        }}
                      >
                        -
                      </button>
                      ...
                      <button
                        onClick={() => {
                          handleChangeIncrement(ele.product);
                        }}
                      >
                        +
                      </button>
                    ...
                    <td>
                      <button
                        onClick={() => {
                          handleChangeremove(ele.product);
                        }}
                      >
                        delete
                      </button>
